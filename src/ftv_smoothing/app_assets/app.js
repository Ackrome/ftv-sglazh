...
const HELP_TEXT = {
  en: {
    ...
    roi_sample_count: "Number of most-changed areas to export as 2D and 3D before/after examples. Use 0 to disable. The app exports up to 4.",
  ...
  ru: {
    ...
    roi_sample_count: "Сколько самых измененных участков экспортировать как 2D и 3D примеры до/после. 0 отключает экспорт. Приложение экспортирует до 4 участков.",
